...
class SuratPengantarController extends Controller
{
    public function index()
    {
        ...
        return view('sekretaris.pengantar.index', ['breadcrumb' => $breadcrumb, 'pengantar' => $pengantar, 'activeMenu' => $activeMenu]);
    }
    public function list(Request $request)
    {
        ...
        return DataTables::of($pengantar)
            ...
            ->addColumn('Action', function ($pengantar) {
                $btn = '<a href="' . url('/sekretaris/pengantar/' . $pengantar->pengantar_id) . '" class="btn btn-sm"><i class="fas fa-eye" style="color: #BB955C; font-size: 17px;"></i></a>';
                $btn .= '<a href="' . url('/sekretaris/pengantar/cetak_surat_pdf/' . $pengantar->pengantar_id) . '" target="_blank" class="btn btn-sm"><i class="fas fa-print" style="color: #28a745; font-size: 17px;"></i></a>';
    ...
    public function create()
    {
        ...
        return view('sekretaris.pengantar.create', ['breadcrumb' => $breadcrumb, 'user' => $user, 'activeMenu' => $activeMenu]);
    }
    public function store(Request $request)
    {
        ...
        try {
            ...
            return redirect('/sekretaris/pengantar')->with('error', 'Gagal menyimpan PDF: ' . $e->getMessage());
        }

        // Create entry in Arsip Surat as Surat Masuk for sekretaris
        ...
        return redirect('sekretaris/pengantar')->with('success', 'Surat Pengantar berhasil dibuat');
    }
    public function show(string $id)
    {
        ...
        return view('sekretaris.pengantar.show', ['breadcrumb' => $breadcrumb, 'page' => $page, 'pengantar' => $pengantar, 'activeMenu' => $activeMenu]);
    }
    ...
    public function destroy(string $id)
    {
        ...
        if (!$check) {
            return redirect('/sekretaris/pengantar')->with('error', 'Surat Pengantar Keuangan tidak ditemukan');
        }
        try {
            SuratPengantarModel::destroy($id);
            return redirect('/sekretaris/pengantar')->with('success', 'Surat Pengantar RW 05 berhasil dihapus');
        } catch (\Illuminate\Database\QueryException $e) {
            return redirect('/sekretaris/pengantar')->with('error', 'Surat Pengantar RW 05 gagal dihapus');
        }
    }
}
