...
class WargaController extends Controller
{
    ...
    public function indexSementara(WargaDataTable $dataTable)
    {
        ...
        return view('sekretaris.warga.index-sementara', ['breadcrumb' => $breadcrumb, 'warga' => $warga, 'activeMenu' => $activeMenu]);
    }
    ...
    public function list(Request $request)
    {
        ...
        return DataTables::of($kkData)
            ...
            ->addColumn('Anggota Keluarga', function ($kk) {
                $btn = '<a href="' . url('/sekretaris/warga/' . $kk->kk_id) . '" class="btn btn-sm" style="background-color: #BB955C; color: white;">Lihat</a> ';
                return $btn;
            })
    ...
    public function listSementara(Request $request)
    {
        ...
        return DataTables::of($warga)
            ...
            ->addColumn('Aksi', function ($warga) {
                ...
                $showBtn = '<a href="' . url('/sekretaris/warga/show/' . $warga->warga_id) . '" class="btn btn-sm"><i class="fas fa-eye" style="color: #BB955C; font-size: 17px;"></i></a>';
                $editBtn = '<a href="' . url('/sekretaris/warga/edit-warga/' . $kk_id . '/' . $warga->warga_id) . '" class="btn btn-sm"><i class="fas fa-edit" style="color: #007bff;" font-size: 17px;></i></a>';
    ...
    public function createKK()
    {
        ...
        return view('sekretaris.warga.create-tetap-kk', ['breadcrumb' => $breadcrumb, 'kk' => $kk, 'activeMenu' => $activeMenu]);
    }
    ...
    public function createWarga($kk_id)
    {
        ...
        return view('sekretaris.warga.create-tetap-warga', ['breadcrumb' => $breadcrumb, 'kk' => $kk, 'activeMenu' => $activeMenu]);
    }
    ...
    public function show(string $kk_id)
    {
        ...
        return view('sekretaris.warga.show', compact('breadcrumb', 'kepalaKeluarga', 'anggotaKeluarga', 'activeMenu'));
    }
    ...
    public function showSementara(string $warga_id)
    {
        ...
        return view('sekretaris.warga.show-sementara', compact('breadcrumb', 'warga', 'activeMenu'));
    }
    ...
    public function editWarga($kk_id, $warga_id)
    {
        if ($kk_id === 'null') {
            ...
            return view('sekretaris.warga.edit-warga', ['breadcrumb' => $breadcrumb, 'warga' => $warga, 'kk' => $kk, 'activeMenu' => $activeMenu]);
        } else {
    ...
    public function editKK($kk_id)
    {
        ...
        return view('sekretaris.warga.edit-kk', ['breadcrumb' => $breadcrumb, 'kk' => $kk, 'activeMenu' => $activeMenu]);
    }
