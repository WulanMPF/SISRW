...
class BansosController extends Controller
{
    ...
    public function list(Request $request)
    {
        ...
        return DataTables::of($bansoss)
            ...
            ->addColumn('aksi', function ($bansos) {
                ...
                //     return $btn;
                $editBtn = '<a href="' . url('/sekretaris/bansos/edit/' . $bansos->bansos_id) . '" class="btn btn-sm"><i class="fas fa-edit" style="color: #007bff;" font-size: 17px;></i></a>';
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/sekretaris/bansos')->with('success', 'Data penerima bansos berhasil disimpan');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('/sekretaris/bansos')->with('success', 'Data penerima bansos berhasil diperbarui');
    }
    ...
    public function destroy(string $id)
    {
        ...
        if (!$bansos) {
            return redirect('/sekretaris/bansos')->with('error', 'Data bansos tidak ditemukan');
        }
        ...
        try {
            ...
            return redirect('/sekretaris/bansos')->with('success', 'Data bansos berhasil dihapus');
        } catch (\Illuminate\Database\QueryException $e) {
            return redirect('/sekretaris/bansos')->with('error', 'Data bansos gagal dihapus karena masih terdapat tabel lain yang terkait dengan data ini');
        }
    }
    ...
    public function kriteria()
    {
        ...
        return view('sekretaris.bansos.kriteria', ['breadcrumb' => $breadcrumb, 'kriteria' => $kriteria, 'activeMenu' => $activeMenu]);
    }
    ...
    public function listKriteria(Request $request)
    {
        ...
        return DataTables::of($bansoss)
            ->addIndexColumn() // Menambahkan kolom index / no urut (default nmaa kolom: DT_RowINdex)
            ->addColumn('aksi', function ($bansos) {
                $btn = '<a href="' . url('/sekretaris/bansos/editKriteria/' . $bansos->kriteria_id) . '" class="btn btn-sm" style="background-color: #BB955C; color: white; border-radius: 9px;">Edit</a>  &nbsp;';
                return $btn;
            })
    ...
    public function editKriteria(string $id)
    {
        ...
        return view('sekretaris.bansos.edit-kriteria', ['breadcrumb' => $breadcrumb, 'page' => $page, 'kriteria' => $kriteria, 'activeMenu' => $activeMenu]);
    }
    ...
    public function updateKriteria(Request $request, string $id)
    {
        ...
        return redirect('/sekretaris/bansos/kriteria')->with('success', 'Data kriteria bansos berhasil diubah');
    }
    ...
    public function perangkingan()
    {
        ...
        return view('sekretaris.bansos.perangkingan', ['breadcrumb' => $breadcrumb, 'bansos' => $bansos, 'warga' => $warga, 'activeMenu' => $activeMenu]);
    }
    ...
    public function moora()
    {
        ...
        return view('sekretaris.bansos.moora', compact('kriteria', 'penerimaBansos', 'sample', 'normal', 'optimasi', 'results', 'breadcrumb', 'activeMenu'));
    }
    ...
    public function saw()
    {
        ...
        return view('sekretaris.bansos.saw', compact('kriteria', 'penerimaBansos', 'sample', 'normal', 'preferensi', 'results', 'breadcrumb', 'activeMenu'));
    }
}
