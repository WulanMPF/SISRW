...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-4 text-right">
            <a href="{{ url('sekretaris/pengumuman/create') }}" class="btn btn-sm btn-primary mt-1 btn-tambah">+ Buat Pengumuman</a>
        </div>
    </div>
    <div class="row mt-3">
        <div class="col-md-12">
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                $.each(response, function(index, item) {
                    html += '<div class="col-md-4">'; // Gunakan card-columns untuk tampilan yang lebih baik
                    html += '<div class="card">';
