...
@section('content')
    ...
    <div class="row" style="margin-left:0.5rem; margin-right:1rem;">
        <div class="col-lg-6">
            <div class="card" style="background-color:white;">
                <div class="card-body">
                    <h5 class="card-title">Jumlah Laki-Laki dan Perempuan di RW 05</h5>
                    <!-- Pie Chart -->
                    <div id="pieChart"></div>
                    <!-- End Pie Chart -->
                </div>
        ...
        <div class="col-lg-6">
            <div class="card" style="background-color:white;">
                <div class="card-body">
                    <h5 class="card-title">Banyak UMKM Berdasarkan Jenis Usaha</h5>
                    <!-- Bar Chart -->
                    <div id="barChart"></div>
                    <!-- End Bar Chart -->
                </div>
        ...
        <div class="col-lg-6">
            <div class="card" style="background-color:white;">
                <div class="card-body">
                    <h5 class="card-title">Persentase Status Pengaduan</h5>
                    <!-- Donut Chart -->
        ...
        <div class="col-lg-6">
            <div class="card" style="background-color:white;">
                <div class="card-body">
                    <h5 class="card-title">Pekerjaan Warga RW 05</h5>
                    <!-- Bar Chart -->
...
@push('js')
    <script>
        ...
        // Line Chart for Pemasukan and Pengeluaran
         ...
         var pieChartOptions = {
            series: [{{ $jumlah_laki_laki }}, {{ $jumlah_perempuan }}],
        ...
        // Bar Chart for UMKM by Jenis Usaha
        var barChartOptions = {
            series: [{
                data: @json(array_values($jenis_usaha_counts))
            }],
            chart: {
                type: 'bar',
                height: 350
            ...
            xaxis: {
                categories: @json(array_keys($jenis_usaha_counts)),
            },
            yaxis: {
                title: {
                    text: 'Jumlah'
        ...
        var donutChartOptions = {
            series: [{{ $persentase_selesai }}, {{ $persentase_diproses }}, {{ $persentase_ditunda }}],
            labels: ['Selesai', 'Diproses', 'Ditunda'],
            chart: {
                type: 'donut',
                height: 350
            },
        ...
        // Bar Chart for Warga by Pekerjaan
        var pekerjaanBarChartOptions = {
            series: [{
                data: @json(array_values($pekerjaan_counts))
            }],
            chart: {
                type: 'bar',
                height: 350
            ...
            xaxis: {
                categories: @json(array_keys($pekerjaan_counts)),
            },
            yaxis: {
                title: {
                    text: 'Jumlah'
        ...
        var pekerjaanBarChart = new ApexCharts(document.querySelector("#barChart2"), pekerjaanBarChartOptions);
        pekerjaanBarChart.render();
    });
        ...
        //         }
        //     }).render();
        //     echarts.init(document.querySelector("#lineChart2")).setOption({
        //         xAxis: {
        //             type: 'category',
