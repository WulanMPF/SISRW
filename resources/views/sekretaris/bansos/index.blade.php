            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group row">
                        <div class="col-2">
                            <a class="btn btn-sm mt-1" id="tambah" href="{{ url('sekretaris/bansos/create') }}">+Tambah Data</a>
                        </div>
                        <div class="col-md-12 text-right">
                            <a class="btn btn-sm mt-1 btn-tambah" data-toggle="dropdown">Lakukan Perangkingan</a>
                            <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                                <a href="{{ url('sekretaris/bansos/moora') }}" class="dropdown-item">
                                    Metode MOORA
                                </a>
                                <a href="{{ url('sekretaris/bansos/saw') }}" class="dropdown-item">
                                    Metode SAW
                                </a>
                            </div>
                        </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#confirmDeleteModal').on('show.bs.modal', function(event) {
                ...
                var form = $('#deleteForm');
                form.attr('action', '{{ url('sekretaris/bansos/destroy') }}/' + bansosId); // Set action form dengan ID UMKM
            });
