                                            ...
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    <div class="form-group has-icon-right">
                                                        <label for="start-month">Bulan Mulai</label>
                                                        <div class="position-relative">
                                                            <select class="form-control" id="start-month" required>
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group has-icon-right">
                                                        <label for="start-year">Tahun Mulai</label>
                                                        <div class="position-relative">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group has-icon-right">
                                                        ...
                                                        <div class="position-relative">
                                                            <select class="form-control" id="end-month" required>
                                                                <option value="1">Januari</option>
                                                                <option value="2">Februari</option>
                                                                <option value="3">Maret</option>
                                                                <option value="4">April</option>
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group has-icon-right">
                                                        <label for="end-year">Tahun Akhir</label>
                                                        <div class="position-relative">
...
@push('js')
    <script>
        $(document).ready(function() {
            ...
            $('#start-month, #start-year, #end-month, #end-year').on('change', updateTotal);
