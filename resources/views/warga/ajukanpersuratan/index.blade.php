    ...
    <div class="card-body">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="mt-3">
                    <p>Surat ini digunakan untuk menjadi tanda bahwa pembawa surat telah diketahui dan disetujui oleh Ketua RT dan RW setempat. Surat pengantar kami lampirkan dan dapat di unduh untuk dapat dipergunakan sebagaimana mestinya. Untuk penggunaannya bisa anda download / unduh template surat pengantar ini kemudian anda cetak, selanjutnya anda isi sesuai kebutuhan dan kemudian mintakan tanda tangan dan stempel pada ketua RT dan RW sesuai domisili anda.</p>
                </div>
            ...
            <div class="modal-body">
                ...
                <form action="{{ route('ajukanpersuratan.create') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="keperluan" name="keperluan" placeholder="Enter purpose" required>
                    </div>
                    <div class="form-group">
