    ...
    <div class="card card-outline card-light">
        ...
        @endif
            ...
            <div class="table-buttons">
                ...
                <a href="{{ url('ketua/warga/edit-kk/' . $kepalaKeluarga->kk->kk_id) }}" class="btn btn-primary btn-edit"><i class="fas fa-edit"></i></a>
                    ...
                    <tbody style="max-width: fit-content; max-height: fit-content">
                        ...
                        @foreach ($anggotaKeluarga as $index => $member)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ url('ketua/warga/edit-warga/' . $kepalaKeluarga->kk->kk_id . '/' . $member->warga_id) }}" class="btn btn-primary btn-edit"><i class="fas fa-edit"></i></a>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="deleteForm" method="POST" action="{{ url('ketua/warga/destroy-kk/' . $kepalaKeluarga->kk->kk_id) }}">
                        @csrf
                        {!! method_field('DELETE') !!}
    ...
    <div class="modal fade" id="deleteModal">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <!-- Modal Body -->
                <div class="modal-body">
                    <form id="deleteForm" method="POST" action="{{ $anggotaKeluarga->isNotEmpty() ? url('ketua/warga/destroy-warga/' . $kepalaKeluarga->kk->kk_id . '/' . $member->warga_id) : '#' }}">
                        @csrf
                        {!! method_field('DELETE') !!}
